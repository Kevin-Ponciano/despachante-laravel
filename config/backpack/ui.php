...
return [
    ...
    */
    ...
    'project_name' => config('app.name', 'Backpack'),
    ...
    'project_logo' => config('app.name', 'Backpack').' <b class="text-body-tertiary">ADMIN</b>',
    ...
    'developer_name' => 'Kevin Ponciano',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'https://github.com/Kevin-Ponciano',
